...
class GalleryFragment : Fragment() {
    ...
    lateinit var reAdapter: MultiImageAdapter
   override fun onCreate(savedInstanceState: Bundle?) {
    ...
    private fun initRecycler(){
        reAdapter = MultiImageAdapter(requireContext())
        binding.recyclerView.adapter = reAdapter
        //context : 액티비티에 객체 붙일 때 사용
        val layoutManager = LinearLayoutManager(requireContext()) // requireContext : context가 null이 아님을 보장
